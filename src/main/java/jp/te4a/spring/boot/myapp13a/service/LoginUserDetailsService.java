package jp.te4a.spring.boot.myapp13a.service;
...
import jp.te4a.spring.boot.myapp13a.repository.UserRepository;
import jp.te4a.spring.boot.myapp13a.security.LoginUserDetails;
@Service
